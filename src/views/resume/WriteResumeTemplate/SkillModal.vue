<template>
  <div>
    <Button @click="modalSkills = true">编辑技能特长</Button>
    <Modal class="jm-skill-modal" v-model="modalSkills">
          ...
          <div class="jm-recom-list">
            ...
            >
              <Col span="8" style="text-align: left;">
                <Icon class="jm-recom-icon" size="20" type="md-close-circle" />
              ...
              <Col span="4" class="jm-recom-tag" style="text-align: right;"
                >精通</Col
              >
            </Row>
          </div>
      ...
      <div class="jm-footer" slot="footer">
        ...
        <Button class="jm-cancle-btn" size="large">取消</Button>
      </div>
    </Modal>
  </div>
</template>
